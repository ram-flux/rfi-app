...
class AppColors {
  /// Custom Colors
  static ActionColorsExtension get actionColors => Get.theme.actionColors;
  static Color get notShown => Get.theme.actionColors.notShown!;
  static Color get mute => Get.theme.actionColors.mute!;
  static Color get delete => Get.theme.actionColors.delete!;
  static Color get archive => Get.theme.actionColors.archive!;
  static Color get addMenu => Get.theme.actionColors.addMenu!;
  static Color get pin => Get.theme.actionColors.pin!;
